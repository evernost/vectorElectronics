...
We've just seen that the common emitter is basically always on. It's the very high transconductance past the $V_{BE} = 0.7V$ that makes all the system work.\\
...
The high gain is rarely used as such (except for comparators) but rather as a feedback gain. In this case, the gain doesn't matter. We just want it to be much greater than 1.
...
\section*{Example 9: the Moog Ladder Filter}
Coming soon.
