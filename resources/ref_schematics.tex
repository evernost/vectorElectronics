...
The purpose of this article is to describe an attempt to solve electronic circuits with non-linear devices like diodes, bipolar transistors, JFETs, MOSFETs, etc.\\
...
The task then reduces to determining which pair applies.
The existence of such a pair is "reassured" by the fact that every circuit necessarily has at least one operating point. 
It is reasonable to assume that this solution is unique, even though certain "pathological" circuits may admit multiple possible operating points (stable or not). We will return to this point later.
