...
Which is a common result and this whole calculation justifies the usual diode approximation: the output does not depend on the polarisation voltage $V$ anymore.
