...
The Ring Modulator is a special arrangement of diodes that, in certain conditions, produces a voltage that is the mathematical product of 2 input voltages. The term \textit{modulator} comes from the fact that this was the way modulation was achieved back in the days. This diode structure appeared in patents dating back from 1934\footnote{US Patent 2,025,158 \textit{Modulating System}, F. A. Cowan, 24 Dec 1934} (!). 
...
\section*{Example 9: the Diode Bridge as variable resistor}

This time, we will study how an actual diode bridge (the same as the one you would use to rectify AC) can be used as a variable resistor. There are patented references to that in 1971 (Patent 3,582,807)
