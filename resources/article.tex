...
Using continuity at $V_{BE} = V_{TH}$, we can determine the voltage $\Delta V^F$ where the source subsystem starts to put $Q1$ in the forward mode:
$$
	\Delta V^F = \dfrac{V_B}{2} - \dfrac{1}{1-\dfrac{aR_E}{1+aR_E}} V_{TH} \simeq \dfrac{V_B}{2} - V_{TH}
$$

Which is a very expected result: TODO.

\begin{table}[H]
	\centering
	\begin{tabular}{|m{1.5cm}||m{5cm}|m{7cm}|}
		\hline
		BJT Mode & BJT Curve & Source Subsystem \\ \hline
