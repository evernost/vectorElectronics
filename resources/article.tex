...
\subsubsection*{Derivation}
Just like with the examples before, we can ignore the base current as a first approximation.
\begin{equation}
\begin{split}
I & = I_R + I_C \\
...
The Class AB Amplifier (or \textit{Push-Pull}) 
...
The Differential Pair (or Long Tailed Pair 😏) is the bread and butter of Operational Amplifiers.
...
\section*{Example 10: the Moog Ladder Filter}
